...
header: false
footer: false
title: "IAIFI Summer School 2026"
show_title: false
--- 
...
Please take a few minutes to complete the IAIFI Summer School survey. Once you complete it, you will get a link to download a certificate of attendance for the Summer School. Your feedback helps us plan for future Summer Schools!

[Complete the Survey](https://bit.ly/2026-post-summer-school){:.button.button--outline-primary.button--pill.button--lg}

### Notes and Reminders

* All slides and tutorial materials from the Summer School can be found on the [IAIFI Summer School GitHub](https://github.com/iaifi/summer-school-2026).

* Recordings from the Summer School can be [viewed here](https://www.dropbox.com/scl/fo/9nxwuutx7x4vfdo5v72x9/AEIXwlG-VJQ_jyzMhYn7LaM?rlkey=01hlg02yx18urzfwhjvuqdyur&dl=0).

* If you attended the Healthy Minds for Masterminds Workshop, please take 5 minutes to fill in the [anonymous POST questionnaire](https://qualtrics.kcl.ac.uk/jfe/form/SV_81VP9jKOayoDsMe). 
...
* If you stayed in the dorms, you will receive a refund for 5 nights to your original form of payment within the next 5-7 business days.

### Friday Lightning Talks

[View Recording](https://www.dropbox.com/scl/fi/hun3z801q650xy9m4n0sr/2026-SS-Lightning-Talks-Friday.mp4?rlkey=jhddlxh7dt4okpcumv4q3s760&dl=0){:.button.button--outline-primary.button--pill.button--lg}  [View Slides](https://drive.google.com/drive/folders/19F7nKzzijoGsKw9zD1XiNoM02mMbRHdk?usp=share_link){:.button.button--outline-primary.button--pill.button--lg}
...
* Best Project: Equation Hunting in Gaia (Emma Graham, Michael Calzadilla, Pablo Mercader, Muhammad Shehzore Hashmi, Talha H Khan, Dmitrii Zagorulia) 
* Best Visualization: Star Spots in the Blind Spot: Learned priors in the null space of the light curve (Emma Chickles) and Gauging Flow(er)s Across Coupling Regimes (Bryan Bliewert, Marina Arvelos, Aneek Jana, Wanyu Lei, Vivan Bhatt)
* Best Team Effort: Equation Hunting in Gaia: A New Closed Form (Adam Kamoski, Dora Demiri, Hanieh Karimi, Akshay Ghalsasi, Indranil Das, Brianna Isola, Luca Javier Gomez, Sid)

### Closing: Mike Williams (IAIFI Director)
