...
## Learning the Simplicity of Scattering Amplitudes with Transformers

<div style="display: flex; justify-content: space-between; gap: 20px;">
  <div style="flex: 1;"><em>By Clifford Cheung (Caltech), Aurélien Dersy (Harvard/IAIFI), and Matthew D. Schwartz (Harvard/IAIFI)</em></div>
  <div style="font-size: x-small; color: gray; white-space: nowrap;">👤 IAIFI | 📅 2025-11-24</div>
</div>
...
[scattering amplitudes](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm} [machine learning](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm} [transformers](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm} [spinor-helicity](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm} [contrastive learning](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm} [symbolic AI](https://iaifi.org/blog){:.button.button--outline-primary.button--pill.button--sm}
...
- **Paper:** “Learning the Simplicity of Scattering Amplitudes,” Cheung, Dersy, Schwartz —[full paper](https://arxiv.org/abs/2408.04720). 
- **Code and interactive demo:** [code/datasets/models on GitHub](https://github.com/aureliendersy/spinorhelicity).
- **Interactive demo:**  [demo](https://spinorhelicity.streamlit.app).
