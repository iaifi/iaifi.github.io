...
author: Samuel Bright-Thonney, Christina Reissel, Gaia Grosso, Nathaniel Woodward, Katya Govorkova, Andrzej Novak, Sang Eon Park, Eric Moreno, Philip Harris
date: 2026-03-01
tags: [machine learning, contrastive learning, symbolic AI]
mathjax: true
---

<div class="highlight-box">
Summarizing a paper published at NeurIPS 2025, IAIFI researchers present AutoSciDACT, the first end-to-end, domain-agnostic pipeline for novelty detection in scientific data that provides rigorous statistical guarantees.
</div>
...
![The AutoSciDACT pipeline, shown alongside the steps of the scientific method it mirrors.](images/autoscidact_draft.png)
...
![Contrastive embeddings for particle physics (left) and gravitational wave (right) datasets.](images/corner_jetclass.png) | ![](images/corner_ligo.png)
:---:|:---:
*Particle physics (JetClass)* | *Gravitational waves (LIGO)*

*Four-dimensional contrastive embeddings, visualized as corner plots. Known background classes appear in shades of blue and green; the held-out anomaly (not seen during training) is overlaid in pink. In particle physics, the Higgs signal forms a distinct elongated cluster. In LIGO data, the white noise burst anomaly appears as an overdensity overlapping with existing classes -- a much harder detection problem.*
...
![Normal heart tissue](images/heart.png) | ![Normal liver tissue](images/liver.png) | ![Diseased liver tissue (NAFLD)](images/NAFLD.png)
:---:|:---:|:---:
*Normal heart tissue* | *Normal liver tissue* | *Liver with NAFLD (anomaly)*
...
![Subspecies A](images/nonhybrid_8.jpg) | ![Subspecies B](images/nonhybrid_9.jpg) | ![Hybrid offspring](images/hybrid_8_9.jpg)
:---:|:---:|:---:
*Subspecies A* | *Subspecies B* | *Hybrid offspring (anomaly)*

---

## Key Results: Sensitivity Across Domains

The headline result is summarized in the figure below, showing detection significance (Z-score) as a function of the fraction of anomalous signal injected into each dataset. In many cases, NPLM achieves highly significant detections ($Z \gtrsim 3$) with small signal fractions.

| | |
|:---:|:---:|
| ![Synthetic](images/cifar10_class1Anom_Zsummary_withMMDFID.png) | ![Particle Physics](images/jetclass_Hbb_Zsummary_withMMDFID.png) |
| *Synthetic data* | *Particle physics (JetClass)* |
| ![Astronomy](images/LIGO_WNB_Zsummary_withMMDFID.png) | ![Histology](images/histology_Zsummary_withMMDFID.png) |
| *Gravitational waves (LIGO)* | *Histopathology* |
...
![Four-lepton invariant mass versus NPLM anomaly score for simulated backgrounds (filled contours) and real CMS data (black points).](images/higgs_mass_vs_anomScore_nplm_4dContrastive.png)
...
[1] P. Khosla, P. Teterwak, C. Wang, A. Sarna, Y. Tian, P. Isola, A. Maschinot, C. Liu, D. Krishnan. "Supervised Contrastive Learning." *Advances in Neural Information Processing Systems* **33**, 18661--18673, 2020.

[2] T. Chen, S. Kornblith, M. Norouzi, G. Hinton. "A Simple Framework for Contrastive Learning of Visual Representations." *International Conference on Machine Learning (ICML)*, 1597--1607, 2020.

[3] R. T. D'Agnolo, A. Wulzer. "Learning New Physics from a Machine." *Physical Review D* **99**(1), 015014, 2019.

[4] R. T. D'Agnolo, G. Grosso, M. Pierini, A. Wulzer, M. Zanetti. "Learning Multivariate New Physics." *European Physical Journal C* **81**(1), 89, 2021.

[5] J. Neyman, E. S. Pearson. "On the Problem of the Most Efficient Tests of Statistical Hypotheses." *Philosophical Transactions of the Royal Society of London A* **231**, 289--337, 1933.

[6] M. Letizia, G. Losapio, M. Rando, G. Grosso, A. Wulzer, M. Pierini, M. Zanetti, L. Rosasco. "Learning New Physics Efficiently with Nonparametric Methods." *European Physical Journal C* **82**(10), 879, 2022.

[7] G. Grosso, M. Letizia, M. Pierini, A. Wulzer. "Goodness of Fit by Neyman-Pearson Testing." *SciPost Physics* **16**(5), 123, 2024.

[8] G. Grosso, M. Letizia. "Multiple Testing for Signal-Agnostic Searches for New Physics with Machine Learning." *European Physical Journal C* **85**(1), 4, 2025.

[9] H. Qu, C. Li, S. Qian. "Particle Transformer for Jet Tagging." arXiv:2202.03772, 2022.

[10] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, L. Kaiser, I. Polosukhin. "Attention Is All You Need." *Advances in Neural Information Processing Systems* **30**, 2017.

[11] J. Aasi et al. (LIGO Scientific Collaboration). "Advanced LIGO." *Classical and Quantum Gravity* **32**, 074001, 2015.

[12] K. He, X. Zhang, S. Ren, J. Sun. "Deep Residual Learning for Image Recognition." *Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 770--778, 2016.

[13] E. Marx et al. "Machine-Learning Pipeline for Real-Time Detection of Gravitational Waves from Compact Binary Coalescences." *Physical Review D* **111**(4), 042010, 2025.

[14] I. Zingman, B. Stierstorfer, F. Heinemann. "NAFLD Pathology and Healthy Tissue Samples." 2022. Available at https://osf.io/gqutd/.

[15] M. Tan, Q. V. Le. "EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks." *International Conference on Machine Learning (ICML)*, 6105--6114, 2019.

[16] I. Zingman, B. Stierstorfer, C. Lempp, F. Heinemann. "Learning Image Representations for Anomaly Detection: Application to Discovery of Histological Alterations in Drug Development." *Medical Image Analysis* **92**, 103067, 2024.

[17] S. Stevens, J. Wu, M. J. Thompson, E. G. Campolongo, C. H. Song, D. E. Carlyn, L. Dong, W. M. Dahdul, C. Stewart, T. Berger-Wolf, W.-L. Chao, Y. Su. "BioCLIP: A Vision Foundation Model for the Tree of Life." arXiv:2311.18803, 2023.

[18] K. Lee, K. Lee, H. Lee, J. Shin. "A Simple Unified Framework for Detecting Out-of-Distribution Samples and Adversarial Attacks." *Advances in Neural Information Processing Systems* **31**, 2018.

[19] G. Kasieczka et al. "The LHC Olympics 2020: A Community Challenge for Anomaly Detection in High Energy Physics." *Reports on Progress in Physics* **84**(12), 124201, 2021.
...
[21] A. Gretton, K. M. Borgwardt, M. Rasch, B. Scholkopf, A. Smola. "A Kernel Two-Sample Test." *Journal of Machine Learning Research* **13**, 723--773, 2012.

[22] Dowson, D. C., & Landau, B. (1982). "The Frechet distance between multivariate normal distributions." *Journal of multivariate analysis*, 12(3), 450-455.

[23] Heusel, M., Ramsauer, H., Unterthiner, T., Nessler, B., & Hochreiter, S. (2017). "Gans trained by a two time-scale update rule converge to a local nash equilibrium." *Advances in neural information processing systems*, 30.

[24] S. Chatrchyan et al. (CMS Collaboration). "Observation of a New Boson at a Mass of 125 GeV with the CMS Experiment at the LHC." *Physics Letters B* **716**, 30--61, 2012.

[25] G. Aad et al. (ATLAS Collaboration). "Observation of a New Particle in the Search for the Standard Model Higgs Boson with the ATLAS Detector at the LHC." *Physics Letters B* **716**, 1--29, 2012.
