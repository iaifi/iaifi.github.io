...
## About
IAIFI members are encouraged to submit ideas for community building events/activities that they would like to organize. If the IAIFI Community Building committee approves the event (per the guidelines listed below), then participants will receive reimbursement (up to 25 USD per participant, maximum 250 USD per event) after the event.
...
* The budget is up to 25 USD per participant, with a maximum of 250 USD total per event. 
...
## FAQ
* *Does each participant need to be reimbursed individually?* No, one person can cover the cost and be reimbursed the full amount (up to 25 USD per participant, maximum 250 USD).
