...
{% assign event_list = event_list| sort: "talk-date" %}
      ...
      {% for column in site.data.calendar.columns %}
        <div class="cell cell--{{column.column_width}}">
          ...
          {% for event in event_list %}
            {% assign start_date_time_in_seconds = event.talk-date | date: "%s" | times: 1 %}
            {% assign duration_in_minutes = event.duration_in_minutes | default: 60 %}
